...
// Format nomor konsumen ke 20140001
function format_no_konsumen($no)
{
    // Ambil nilai prefix dari file konfigurasi "psb.php"
    $prefix = config_item('psb_prefix_no_konsumen');    
    $leadingzeros = '0000';
    $no_konsumen = $prefix . substr($leadingzeros, 0, (-strlen($no))) . $no;
    return $no_konsumen;
}

// Mendapatkan nilai interger no_konsumen
function get_no_konsumen_value($no_konsumen)
{
    return intval(substr($no_konsumen, 4, 4));
}
