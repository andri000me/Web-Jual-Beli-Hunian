<nav class="navbar navbar-inverse" role="navigation">
    <div class="container">
        ...
        <ul class="nav navbar-nav navbar-left">
            <!-- Dropdown Home -->
            <?php echo (isset($halaman) && $halaman == 'home') ? '<li class="active">' : '<li>'; ?> <?php echo anchor(base_url(), '<span class="glyphicon glyphicon-home"></span> Beranda');?></li>

            <!-- Dropdown Konsumen -->
            <?php echo (isset($halaman) && $halaman == 'konsumen') ? '<li class="active">' : '<li>'; ?> <?php echo anchor('konsumen', '<span class="glyphicon glyphicon-list-alt"></span> Data Konsumen');?></li>
            ...
            <ul class="dropdown-menu" role="menu">
                <?php echo (isset($halaman) && $halaman == 'pengumuman') ? '<li class="active">' : '<li>'; ?> <?php echo anchor('pengumuman', '<span class="glyphicon glyphicon-bullhorn"></span> Berita');?></li>
                ...
                <?php echo (isset($halaman) && $halaman == 'jadwal') ? '<li class="active">' : '<li>'; ?> <?php echo anchor('jadwal', '<span class="glyphicon glyphicon-calendar"></span> Cek Ketersediaan');?></li>
            </ul>
            </li>
