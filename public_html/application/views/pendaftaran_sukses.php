<div class="container" id="daftar-sukses">
    ...
    <p>Gunakan akun di bawah ini untuk login dan mengisi biodata serta untuk mencetak biodata yang sudah tertera bukti pembayaran.</p>

    <div class="row">
        <div class="col-xs-4 col-md-2">No Konsumen</div>
        <div class="col-xs-8 col-md-10">: <strong><?php echo $this->session->userdata('nomor_konsumen'); ?></strong></div>
    </div>
