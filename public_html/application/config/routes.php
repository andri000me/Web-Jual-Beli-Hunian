...
// Public
$route['konsumen/halaman/(:num)'] = 'konsumen/index/$1';
...
// Dashboard
$route['dashboard/konsumen/halaman/(:num)'] = 'dashboard/konsumen/index/$1';
...
$route['admin/konsumen/halaman/(:num)'] = "admin/konsumen/index/$1";
$route['admin/konsumen/ubah-status-verifikasi/(:num)'] = "admin/konsumen/ubah_status_verifikasi/$1";
$route['admin/konsumen/ubah-status-seleksi/(:num)'] = "admin/konsumen/ubah_status_seleksi/$1";
$route['admin/konsumen/ubah-status-pendaftaran/(:num)'] = "admin/konsumen/ubah_status_pendaftaran/$1";
